...
namespace WebAPICHATest.Api.Application.Commands.MaintenanceRequests
{
    ...
    public class UpdateMaintenanceRequestCommand : IRequest<bool>
    {
        ...
        public UpdateMaintenanceRequestCommand(string? maintenanceRequestId, string? code, string? problem, DateTime? requestedCompletionDate, int? requestedPriority, string? requester, string? status, string? reviewer, DateTime? submissionDate, string? type, string? maintenanceObject, string? equipment, string? mold, List<string>? images, List<string>? sounds, string? responsiblePerson, int? estProcessingTime, DateTime? plannedStart)
        {
