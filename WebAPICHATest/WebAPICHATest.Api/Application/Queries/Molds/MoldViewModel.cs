...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public MoldViewModel(string moldId, string? code, string? name, int? cavity, List<Product>? products, string? documentLink, List<string>? images, List<Standard>? standards, PerformanceIndex? mTBF, PerformanceIndex? mTTF, PerformanceIndex? oEE, List<ScheduleEquipmentWorkingTime>? scheduleWorkingTimes, string? status, List<MaintenanceResponseWithoutEquipmentMold>? recentMaintenanceResponses, List<ChartObj>? errors, List<EquipmentMaterial>? materials)
        {
            MoldId = moldId;
            Code = code;
            Name = name;
