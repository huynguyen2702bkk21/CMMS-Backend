...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public EquipmentViewModel(string equipmentId, string? code, string? name, List<ScheduleEquipmentWorkingTime>? scheduleWorkingTimes, string? type, PerformanceIndex? mTBF, PerformanceIndex? mTTF, PerformanceIndex? oEE, string? status, List<MaintenanceResponseWithoutEquipmentMold>? recentMaintenanceResponse, List<ChartObj>? errors, List<EquipmentMaterial>? material)
        {
